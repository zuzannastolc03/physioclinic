    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
        http.authorizeHttpRequests(configurer ->
                configurer
                        ...
                        .requestMatchers(HttpMethod.POST, "/add_therapy").hasRole("PHYSIOTHERAPIST")
                        .requestMatchers(HttpMethod.PUT, "/update_therapy").hasRole("PHYSIOTHERAPIST")
                        .requestMatchers(HttpMethod.DELETE, "/delete_therapy").hasRole("PHYSIOTHERAPIST"));
